...
* $\lambda_n = v_2(\bar{d})/(1 + v_2(\bar{d}) + v_2(\hat{d}))$,
* $\lambda_d = 1/(1 + v_2(\bar{d}) + v_2(\hat{d}))$,
* $\lambda_c = v_2(\hat{d})/(1 + v_2(\bar{d}) + v_2(\hat{d}))$.
...
#saveRDS(df, "./data/opt_phIII.Rda")
```

```{r}
df <- readRDS("./data/opt_phIII.Rda")
```
...
#saveRDS(df_sen, "./data/opt_phIII_sen.Rda")
```

```{r}
df_sen <- readRDS("./data/opt_phIII_sen.Rda")
```
